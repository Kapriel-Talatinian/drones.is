...
5. Read [`CONTRIBUTING.md`](CONTRIBUTING.md) for branch, review, and issue-tracking conventions.
...
- Add co-authored commits when pairing (e.g., `Co-authored-by: chingjui-lin@edu.ece.fr`) so shared work is visible in history.
- Keep branch names focused (`feature/seed-drop-spacing`, `fix/geojson-import`), and update the GitHub report as branches close.
